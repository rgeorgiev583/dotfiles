...
abbr --add --global gbsu 'git branch --set-upstream-to=origin/(git rev-parse --abbrev-ref HEAD)'
abbr --add --global gpsu 'git push --set-upstream origin (git rev-parse --abbrev-ref HEAD)'
...
abbr --add --global gkp 'gitk --all (git log -g --pretty=%h)'
abbr --add --global gp 'git pull'
abbr --add --global gpp 'git pull --prune'
abbr --add --global gl 'git log'
abbr --add --global gls 'git log --stat'
abbr --add --global glsp 'git log --stat -p'
abbr --add --global glg 'git log --graph'
abbr --add --global glga 'git log --graph --decorate --all'
...
abbr --add --global gmb 'git merge-base'
abbr --add --global gpu 'git push'
abbr --add --global gpud 'git push --dry-run'
abbr --add --global gpuf 'git push --force-with-lease'
abbr --add --global gpuf! 'git push --force'
abbr --add --global gput 'git push --tags'
abbr --add --global gpuat 'git push --all && git push --tags'
abbr --add --global gpuo 'git push origin'
abbr --add --global gpuu 'git push upstream'
abbr --add --global gpuv 'git push -v'
...
abbr --add --global grp 'git reset --patch'
...
abbr --add --global gstpu 'git stash push'
abbr --add --global gstpa 'git stash --patch'
abbr --add --global gsts 'git stash show --text'
abbr --add --global gstall 'git stash --all'
abbr --add --global gsu 'git submodule update'
abbr --add --global gsui 'git submodule update --init --recursive'
...
abbr --add --global gprv 'git pull --rebase -v'
abbr --add --global gpra 'git pull --rebase --autostash'
abbr --add --global gprav 'git pull --rebase --autostash -v'
