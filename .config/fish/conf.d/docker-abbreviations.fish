...
set docker_compose_project_cmd "$docker_compose_cmd -p (basename (pwd))"

abbr --add --global dc "$docker_compose_cmd"
abbr --add --global dce "$docker_compose_project_cmd exec"
abbr --add --global dcr "$docker_compose_project_cmd run"
abbr --add --global dcrr "$docker_compose_project_cmd run --rm"
abbr --add --global dcs "$docker_compose_project_cmd stop"
abbr --add --global dcst "$docker_compose_project_cmd start"
abbr --add --global dcrs "$docker_compose_project_cmd restart"
abbr --add --global dcu "$docker_compose_cmd up"
abbr --add --global dcud "$docker_compose_cmd up -d"
abbr --add --global dcd "$docker_compose_project_cmd down"
abbr --add --global dcl "$docker_compose_project_cmd logs --no-log-prefix"
abbr --add --global dclf "$docker_compose_project_cmd logs --no-log-prefix -f"
abbr --add --global dcp "$docker_compose_project_cmd"
abbr --add --global dcpp "$docker_compose_project_cmd ps"
abbr --add --global dcpl "$docker_compose_project_cmd pull"
abbr --add --global dcps "$docker_compose_project_cmd push"
abbr --add --global dck "$docker_compose_project_cmd kill"
abbr --add --global dcb "$docker_compose_project_cmd build"
abbr --add --global dci "$docker_compose_project_cmd images"
