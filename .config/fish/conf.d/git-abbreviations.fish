...
abbr --add --global gpristine 'git reset --hard && git clean -dfx'
...
abbr --add --global git-svn-dcommit-push 'git svn dcommit && git push github master:svntrunk'
...
abbr --add --global glp '_git_log_prettily'
